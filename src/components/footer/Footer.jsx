...
{/* <div className={styles.slider}>
<div className={styles.imageContainer}>
    <img src={image1} alt="company qualities" />
</div>
<div className={styles.imageContainer}>
    <img src={image2} alt="company qualities" />
</div>
<div className={styles.imageContainer}>
    <img src={image3} alt="company qualities" />
</div>
<div className={styles.imageContainer}>
    <img src={image4} alt="company qualities" />
</div>
<div className={styles.imageContainer}>
    <img src={image5} alt="company qualities" />
</div>
<div className={styles.imageContainer}>
    <img src={image6} alt="company qualities" />
</div>
<div className={styles.imageContainer}>
    <img src={image7} alt="company qualities" />
</div>
<div className={styles.imageContainer}>
    <img src={image8} alt="company qualities" />
</div>
<div className={styles.imageContainer}>
    <img src={image1} alt="company qualities" />
</div>
